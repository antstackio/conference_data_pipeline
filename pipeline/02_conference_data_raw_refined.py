...
inperson_attendee_df = spark.sql(
  ...
  from conference_raw.in_person_attendee where is_processed is false"""
)
...
virtual_attendee_df = spark.sql(
  ...
  from conference_raw.virtual_attendee where is_processed is false"""
)
...
# MAGIC %sql
# MAGIC SELECT count(*) FROM attendee_temp_view;
...
# MAGIC ) AS src
# MAGIC ON src.email_address = des.email_address
...
# MAGIC %sql
# MAGIC create or replace temp view attendee_dim_temp_view as
# MAGIC SELECT
# MAGIC   d.*,
...
# MAGIC %sql
# MAGIC SELECT count(*) from attendee_dim_temp_view;
...
# MAGIC %sql
# MAGIC CREATE OR REPLACE TEMP VIEW questions as 
# MAGIC Select DISTINCT poll_question from polling_questions_master_temp_view

# COMMAND ----------

# MAGIC %sql
# MAGIC SELECT count(*) from questions;
...
# MAGIC %sql
# MAGIC INSERT INTO conference_refined.question_attendee_dim
# MAGIC SELECT
# MAGIC   q.question_id,
# MAGIC   a.attendee_id,
# MAGIC   t.option_text,
...
# MAGIC   LEFT JOIN conference_refined.attendee_dim a on a.first_name = at.first_name and a.last_name = at.last_name and a.job_role = at.job_role AND a.state = at.state

# COMMAND ----------

# MAGIC %sql
# MAGIC SELECT * FROM conference_refined.questions_dim;

# COMMAND ----------

# MAGIC %sql
# MAGIC CREATE or REPLACE TEMP VIEW question_agg as
# MAGIC SELECT
...
# MAGIC %sql
# MAGIC CREATE or REPLACE TEMP VIEW option_agg as
# MAGIC SELECT
...
# MAGIC %sql
# MAGIC CREATE or replace temp view question_options_temp_view as
# MAGIC SELECT
# MAGIC   DISTINCT
# MAGIC   poll_question,
# MAGIC   poll_option,
# MAGIC   option_text,
# MAGIC   session_title
# MAGIC from polling_questions_master_temp_view
# MAGIC WHERE option_text != 'null'
# MAGIC ORDER BY
# MAGIC poll_question,
# MAGIC poll_option
...
# MAGIC %sql
# MAGIC SELECT count(*) from question_options_temp_view;

# COMMAND ----------

# MAGIC %sql
# MAGIC SELECT count(*) from polling_questions_master_temp_view WHERE session_title = 'null';

# COMMAND ----------

# MAGIC %sql
# MAGIC INSERT INTO conference_refined.event_poll_fact 
# MAGIC SELECT 
...
# MAGIC current_date() as create_date,
# MAGIC current_user() as create_user
# MAGIC FROM question_options_temp_view pt 
# MAGIC LEFT JOIN question_agg pa on pt.poll_question = pa.poll_question
# MAGIC LEFT JOIN option_agg qa on qa.option_text = pt.option_text AND qa.poll_option = pt.poll_option
# MAGIC LEFT JOIN session_dim_temp_view s on s.session_title = pt.session_title
# MAGIC ORDER BY pt.poll_question

# COMMAND ----------

# MAGIC %sql
# MAGIC SELECT * from conference_refined.event_poll_fact

# COMMAND ----------

# MAGIC %sql
# MAGIC SELECT count(*) FROM conference_refined.attendee_session_dim;
